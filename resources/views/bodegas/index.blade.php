				...
				<div class="card-header bg-dark">
					<div class="row">
						...
						<div class="col-md-2">
							...
							<a href="{{route('bodegas.create')}}" class="btn btn-danger">Nuevo</a>
						</div>
					</div>
				</div>
				<div class="card-body">
					...
					<div class="row">
						...
						<a href="{{route('bodegas.edit',$bod->bod_id)}}"style="background:#46b6d0;" class="btn btn-primary">
							<svg xmlns="http://www.w3.org/2000/svg" width="50" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
